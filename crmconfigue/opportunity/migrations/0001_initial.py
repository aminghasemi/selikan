# Generated by Django 3.0.6 on 2021-01-16 09:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='opportunities', to='accounts.Account', verbose_name='حساب')),
                ('assigned_to', models.ManyToManyField(related_name='opportunity_assigned_to', to=settings.AUTH_USER_MODEL, verbose_name='محول شده به')),
                ('closed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='منعقد شده توسط')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.Company', verbose_name='شرکت')),
                ('contacts', models.ManyToManyField(to='contacts.Contact', verbose_name='مشتری')),
                ...
                ('tags', models.ManyToManyField(blank=True, to='accounts.Tags', verbose_name='تگ هه')),
                ('teams', models.ManyToManyField(related_name='oppurtunity_teams', to='teams.Teams', verbose_name='تیم')),
            ],
            options={
                'ordering': ['-created_on'],
            },
