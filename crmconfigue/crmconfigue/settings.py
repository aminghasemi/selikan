"""
Django settings for crmconfigue project.
...
SECRET_KEY = 'axndae)8$g%r4_ca5n@(1*@0kafhw(o7_st3ixi5+r*dsw@b(a'
...
TEMPLATES = [
    {
        ...
        'builtins': [
            'common.templatetags.auth_extras',                
            ],
        },
    },
]

WSGI_APPLICATION = 'crmconfigue.wsgi.application'
