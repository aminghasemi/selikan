...
class Dealreport(models.Model):
    ...
    converted_by = models.ForeignKey(Enrolled, on_delete=models.SET_NULL,null=True,related_name="report_deal_converted_by", blank=True, verbose_name="تکمیل‌شده توسط")
...
class Leadreport(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد")
    converted_by = models.ForeignKey(Enrolled, on_delete=models.SET_NULL,null=True,related_name="report_lead_converted_by", blank=True, verbose_name="تکمیل‌شده توسط")
    startdate = models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
    enddate= models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
...
class Opportunityreport(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد")
    converted_by = models.ForeignKey(Enrolled, on_delete=models.SET_NULL,null=True,related_name="report_opportunity_converted_by", blank=True, verbose_name="تکمیل‌شده توسط")
    startdate = models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
    enddate= models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
...
class Taskreport(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد")
    done_by = models.ForeignKey(Enrolled, on_delete=models.SET_NULL,null=True,related_name="report_task_converted_by", blank=True, verbose_name="تکمیل‌شده توسط")
    startdate = models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
    enddate= models.DateField(blank=True,null=True, verbose_name="تاریخ تکمیل")
